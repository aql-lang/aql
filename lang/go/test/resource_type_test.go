...
func TestResourceTypeDefine(t *testing.T) {
	result, err := runNativeSteps(t, nil, []string{
		`def Resrc maketype Record [name:String kind:String meta:Map]`,
		`Resrc`,
	})
	if err != nil {
		t.Fatal(err)
...
func TestResourceTypeTable(t *testing.T) {
	result, err := runNativeSteps(t, nil, []string{
		`def Resrc maketype Record [name:String kind:String meta:Map]`,
		`def Resrcs maketype Table Resrc`,
...
func TestEntityTypeDefine(t *testing.T) {
	result, err := runNativeSteps(t, nil, []string{
		`def Ent maketype Record [name:String kind:"entity" meta:Map entity:Map model:Map]`,
		`Ent`,
	})
	if err != nil {
		t.Fatal(err)
