...
var makeNatives = []NativeFunc{
	{
		...
		Signatures: []NativeSig{
			...
			// never dispatches.
			{Args: []*Type{TArray, TList}, TypeArgs: map[int]bool{0: true}, Impl: Go(eng.MakeArrayHandler), ReturnsFn: makeArrayReturns, BarrierPos: -1},
			...
			{Args: []*Type{TObject, TAny, TObject}, Impl: Go(eng.MakeWithPrototype), Returns: []*Type{TObject}, BarrierPos: -1},
