...
var (
	TTimeout  = registerTimerType("Ideal/Object/Timeout", 4000, timeoutFormatBehavior{})
	TInterval = registerTimerType("Ideal/Object/Interval", 4001, intervalFormatBehavior{})
)
