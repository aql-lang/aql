...
// an AQL Value into a string. It is the symmetric inverse of the tabnas
...
// emitError is a typed error carrying the AQL error code so the module layer
// can surface it via r.AqlError without string-matching.
...
// EmitErrorCode returns the AQL error code for an emit error, or "" if err is
// not an emitError.
