...
func TestShrinkLiteral_NilParent(t *testing.T) {
	if got := shrinkLiteral(core.Value{}); got != nil {
...
func TestShrinkLiteral_UnhandledTypeReturnsNil(t *testing.T) {
	if got := shrinkLiteral(core.NewAtom("foo")); got != nil {
...
func TestShrinkLiteral_FloatRoutesToShrinkFloat(t *testing.T) {
	got := shrinkLiteral(core.NewFloat(4.0))
	// shrinkFloat(4.0) → [0.0, 2.0].
	if len(got) != 2 {
		t.Fatalf("shrinkLiteral(4.0) len = %d, want 2: %v", len(got), got)
	}
	f0, _ := core.AsFloat(got[0])
	f1, _ := core.AsFloat(got[1])
	if f0 != 0.0 {
...
func TestShrinkInteger_ErrorReturnsNil(t *testing.T) {
	if got := shrinkInteger(core.NewTypeLiteral(core.TInteger)); got != nil {
...
func TestShrinkInteger_Negative(t *testing.T) {
	got := shrinkInteger(core.NewInteger(-4))
...
func TestShrinkInteger_PositiveBoundary(t *testing.T) {
	got := shrinkInteger(core.NewInteger(5))
	// n=5: → 0; → 2 (5/2); → 4 (5-1).
	want := []int64{0, 2, 4}
	if len(got) != len(want) {
...
func TestShrinkFloat_NonZeroAndHalving(t *testing.T) {
	got := shrinkFloat(core.NewFloat(8.0))
	// f=8: → 0.0; → 4.0 (halving).
	if len(got) != 2 {
...
func TestShrinkFloat_ZeroReturnsEmpty(t *testing.T) {
	if got := shrinkFloat(core.NewFloat(0.0)); len(got) != 0 {
...
func TestShrinkFloat_SmallMagnitudeNoHalving(t *testing.T) {
	got := shrinkFloat(core.NewFloat(0.5))
	if len(got) != 1 {
...
func TestShrinkFloat_ErrorReturnsNil(t *testing.T) {
	if got := shrinkFloat(core.NewTypeLiteral(core.TFloat)); got != nil {
...
func TestShrinkString_ErrorReturnsNil(t *testing.T) {
	if got := shrinkString(core.NewTypeLiteral(core.TString)); got != nil {
...
func TestShrinkBoolean_ErrorReturnsNil(t *testing.T) {
	if got := shrinkBoolean(core.NewTypeLiteral(core.TBoolean)); got != nil {
...
func TestShrinkList_Empty(t *testing.T) {
	if got := shrinkList(core.NewList([]core.Value{})); got != nil {
...
func TestShrinkList_NilBackedErrorsOut(t *testing.T) {
	if got := shrinkList(core.NewList(nil)); got != nil {
...
func TestShrinkList_MultiElement(t *testing.T) {
	...
	half, _ := core.AsList(got[1])
	if n, _ := core.AsInteger(half.Get(0)); n != 10 {
		t.Errorf("first-half[0] = %d, want 10", n)
	}
	if n, _ := core.AsInteger(half.Get(1)); n != 20 {
...
func TestShrinkList_SingleElement(t *testing.T) {
	got := shrinkList(core.NewList([]core.Value{core.NewInteger(9)}))
	if len(got) != 1 {
		t.Fatalf("shrinkList(1-elem) len = %d, want 1: %v", len(got), got)
	}
	rl, _ := core.AsList(got[0])
	if rl.Len() != 0 {
