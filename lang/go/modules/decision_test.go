...
func decisionRegistry(t *testing.T) *native.Registry {
	t.Helper()
...
func runDecisionAQL(t *testing.T, r *native.Registry, src string) []native.Value {
	t.Helper()
