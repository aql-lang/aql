...
import (
	...
	_ "github.com/aql-lang/aql/lang/engine"
	_ "github.com/aql-lang/aql/lang/internal/nativemod"
	_ "github.com/aql-lang/aql/lang/native"
)
...
// externally-registered types (Fetch in lang/native, Matrix in
// lang/internal/nativemod, Timeout/Interval and the Time family
// in lang/engine) — is checked against the snapshot below. A
...
func TestFixedIDStability(t *testing.T) {
	expected := map[string]int{
		...
		"Scalar/Time":                      1000, // time family — lang/engine/native_temporal.go
		...
		"Object/Timeout":                   4000, // timer types — lang/engine/native_misc.go
