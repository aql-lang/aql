...
func TestMathPow(t *testing.T) {
	...
	_as1, _ := engine.AsInteger(result[0])
	if _as1 != 1 {
...
func TestMathDiv(t *testing.T) {
	...
	_as4, _ := engine.AsNumber(result[0])
	if _as4 != 2.5 {
...
func TestMathMod(t *testing.T) {
	...
	_as6, _ := engine.AsNumber(result[0])
...
func TestMathMulDecimal(t *testing.T) {
	...
	_as7, _ := engine.AsNumber(result[0])
	if _as7 != 10.0 {
...
func TestMathSubDecimal(t *testing.T) {
	...
	_as8, _ := engine.AsNumber(result[0])
	if _as8 != 3.0 {
...
func TestMathAddDecimal(t *testing.T) {
	...
	_as9, _ := engine.AsNumber(result[0])
	if _as9 != 4.0 {
...
func TestBoolXor(t *testing.T) {
	...
	for _, tt := range tests {
		...
		_as10, _ := engine.AsBoolean(result[0])
		if _as10 != tt.want {
			_as11, _ := engine.AsBoolean(result[0])
...
func TestBoolNand(t *testing.T) {
	...
	_as12, _ := engine.AsBoolean(result[0])
	if _as12 != false {
	...
	_as13, _ := engine.AsBoolean(result[0])
	if _as13 != true {
...
func TestBoolImplies(t *testing.T) {
	...
	_as14, _ := engine.AsBoolean(result[0])
	if _as14 != false {
	...
	_as15, _ := engine.AsBoolean(result[0])
	if _as15 != true {
...
func TestMathAddMixed(t *testing.T) {
	...
	_as16, _ := engine.AsNumber(result[0])
	if _as16 != 3.5 {
	...
	_as17, _ := engine.AsNumber(result[0])
	if _as17 != 3.5 {
...
func TestStringAdd(t *testing.T) {
	...
	_as18, _ := engine.AsString(result[0])
