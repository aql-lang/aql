...
// (design/TEST-SEAMS.10.md): main() is a single dispatch to aql.Run,
...
func TestSeam5MainDispatchesToAqlRun(t *testing.T) {
	orig := runCLI
	...
	if calls != 1 {
		t.Fatalf("main() invoked aql.Run %d times, want exactly 1", calls)
	}
}
