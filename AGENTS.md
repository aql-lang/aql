...
| `basic/go/` | The base language layer: fundamental words (stack, definition, control, type-generics) + predefined content types. Depends on core+check+parser — not compiler, which it reaches through `core.EmitRecorder` (ADR-013). |
