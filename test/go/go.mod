...
require (
	...
	github.com/tabnas/abnf/go v0.2.3 // indirect
	github.com/tabnas/csv/go v0.4.0 // indirect
	...
	github.com/tabnas/yaml/go v0.4.0 // indirect
	github.com/tabnas/zon/go v0.4.0 // indirect
