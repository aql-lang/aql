...
Corpus: **5901** spec value rows (**5503** compilable, 398 statically invalid in both engines).

## Disposition

| outcome | rows |
| --- | ---: |
| compiled natively (fallback-free) | 5491 |
| compiled with an interpreter island | 1 |
| refused (whole-program fallback) | 11 |
| static check-error (invalid in both engines) | 398 |

**5492 / 5503** compilable rows produce a Program (99% — 5491 of those fully native).
