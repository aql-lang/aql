...
Corpus: **2841** spec value rows (**2527** compilable, 314 statically invalid in both engines).
...
| static check-error (invalid in both engines) | 314 |

**2501 / 2527** compilable rows produce a Program (98% — 2499 of those fully native).
