...
Over the 36 not-fully-native rows (refused or islanded): **0** interpreter-only (tier 1, permanent), **6** reducible (tier 2, TODO), **0** allowlisted error rows, **30** compute-frontier gaps.
