...
Corpus: **2930** spec value rows (**2607** compilable, 323 statically invalid in both engines).

## Disposition

| outcome | rows |
| --- | ---: |
| compiled natively (fallback-free) | 2597 |
| compiled with an interpreter island | 0 |
| refused (whole-program fallback) | 10 |
| static check-error (invalid in both engines) | 323 |

**2597 / 2607** compilable rows produce a Program (99% — 2597 of those fully native).
