...
Corpus: **2897** spec value rows (**2577** compilable, 320 statically invalid in both engines).

## Disposition

| outcome | rows |
| --- | ---: |
| compiled natively (fallback-free) | 2567 |
| compiled with an interpreter island | 0 |
| refused (whole-program fallback) | 10 |
| static check-error (invalid in both engines) | 320 |

**2567 / 2577** compilable rows produce a Program (99% — 2567 of those fully native).
