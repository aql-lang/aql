...
Corpus: **2924** spec value rows (**2601** compilable, 323 statically invalid in both engines).

## Disposition

| outcome | rows |
| --- | ---: |
| compiled natively (fallback-free) | 2591 |
| compiled with an interpreter island | 0 |
| refused (whole-program fallback) | 10 |
| static check-error (invalid in both engines) | 323 |

**2591 / 2601** compilable rows produce a Program (99% — 2591 of those fully native).
