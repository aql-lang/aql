...
Corpus: **2943** spec value rows (**2620** compilable, 323 statically invalid in both engines).

## Disposition

| outcome | rows |
| --- | ---: |
| compiled natively (fallback-free) | 2610 |
| compiled with an interpreter island | 0 |
| refused (whole-program fallback) | 10 |
| static check-error (invalid in both engines) | 323 |

**2610 / 2620** compilable rows produce a Program (99% — 2610 of those fully native).
