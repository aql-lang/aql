...
const (
	pinnedFalsePositives     = 114 // value rows the checker wrongly errors on (June 2026; was 132 — macro installs in check mode; was 122 — make returns a value carrier of the made type, not the type literal)
