...
func TestCheckAnyFrontier(t *testing.T) {
	...
	const anyFrontierRatioCeilingPct = 8 // was 12 — measured 220/3306 ≈ 6.7% July 2026 after the Phase-4.3 G7 return-annotation sweep (declared-Any DSL parser returns shaped/folded: minilang re/gex, parselang pure-source folds, StructUtil, Vm reports, make-record schemas; frontier 381 → 220), +1.3pt headroom. Prior: measured 345/3050 ≈ 11.3% June 2026 (pre-review baseline was 354/3045 ≈ 11.6%), +0.7pt headroom
