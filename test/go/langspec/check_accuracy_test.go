...
const (
	...
	pinnedUnflaggedErrorRows = 140 // ERROR rows the checker is silent on (June 2026; was 139 — +1 patrun.tsv runtime-only error the checker can't predict statically, e.g. a non-Scalar pattern value to `add`; was 136 — +3 module-minilang §7 runtime-only errors: mini_no_transducer / mini_bad_compiler / mini_bad_name; was 131 — +5 module-parselang runtime-only errors; was 132)
)
