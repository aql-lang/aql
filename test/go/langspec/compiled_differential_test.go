...
// documented decision.
const minCompiledRows = 1430 // Stage-5 fallback islands for code-body higher-order words incl. threaded computed-receivers + widened allow-set (filter/outer/inner): 1438 compiled June 2026
