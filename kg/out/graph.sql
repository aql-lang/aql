...
INSERT INTO assertion_evidence VALUES ('ast:2489810833588744883', 'src:readme', 'Repository layout', 'basic/go/ | The base language layer: fundamental words and predefined content types, on core+check+compiler (ADR-013).', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:4135702956650890893', 'src:readme', 'Repository layout', 'basic/go/ | The base language layer: fundamental words and predefined content types, on core+check+compiler (ADR-013).', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:6670089646672814849', 'src:agents', 'Repository layout', 'basic/go/ | The base language layer: fundamental words (stack, definition, control, type-generics) + predefined content types. Depends on core+check+compiler (ADR-013).', 'direct_record', 'kg-ingest');
