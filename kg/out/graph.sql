...
INSERT INTO assertions VALUES ('ast:2489810833588744883', 'ent:Product:4938585304473715098', 'related_to', 'entity', 'ent:Product:5136370952190450338', NULL, NULL, NULL, NULL, 0.95, 'asserted', NULL, NULL, '2026-07-22T00:00:00Z', NULL);
INSERT INTO assertion_evidence VALUES ('ast:2489810833588744883', 'src:readme', 'Repository layout', 'basic/go/ | The base language layer: fundamental words and predefined content types, on core+check+parser (ADR-013).', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:4135702956650890893', 'src:readme', 'Repository layout', 'basic/go/ | The base language layer: fundamental words and predefined content types, on core+check+parser (ADR-013).', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:5247468906425855718', 'src:readme', 'Repository layout', 'calc/go/ | A small calculator built directly on core + parser (learning example).', 'direct_record', 'kg-ingest');
...
INSERT INTO assertion_evidence VALUES ('ast:6670089646672814849', 'src:agents', 'Repository layout', 'basic/go/ | The base language layer: fundamental words (stack, definition, control, type-generics) + predefined content types. Depends on core+check+parser — not compiler, which it reaches through `core.EmitRecorder` (ADR-013).', 'direct_record', 'kg-ingest');
