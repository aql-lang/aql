...
func registerArrFlatten(r *Registry) {
	r.Register("arr-flatten", Signature{
		Args: []Type{TList},
		Handler: func(args []Value, _ map[string]Value, _ []Value, _ *Registry) ([]Value, error) {
			if args[0].Data == nil {
...
func registerArrTranspose(r *Registry) {
	r.Register("arr-transpose", Signature{
		Args: []Type{TList},
		Handler: func(args []Value, _ map[string]Value, _ []Value, _ *Registry) ([]Value, error) {
			if args[0].Data == nil {
...
func registerArrIndexof(r *Registry) {
	r.Register("arr-indexof", Signature{
		Args: []Type{TList, TList},
		Handler: func(args []Value, _ map[string]Value, _ []Value, _ *Registry) ([]Value, error) {
			if args[0].Data == nil {
...
func registerReplicate(r *Registry) {
	r.Register("replicate", Signature{
		Args: []Type{TList, TList},
		Handler: func(args []Value, _ map[string]Value, _ []Value, _ *Registry) ([]Value, error) {
			if args[0].Data == nil {
