...
var (
	...
	RegisterBetween = aqleng.RegisterBetween
	...
	RegisterComparison = aqleng.RegisterComparison
	RegisterPrint = aqleng.RegisterPrint
	RegisterTrace = aqleng.RegisterTrace
	RegisterUnaryNumOp = aqleng.RegisterUnaryNumOp
	RegisterUnify = aqleng.RegisterUnify
