...
var Natives = []engine.NativeFunc{
	...
	// ---- list (table query) ----
	{
		...
		ForwardPrecedence: true,
		Signatures: []engine.NativeSig{
			{Args: []engine.Type{engine.TResourceEntity, engine.TMap}, Handler: listEntityOptsHandler},
			{Args: []engine.Type{engine.TResourceEntity}, Handler: listEntityHandler},
			{Args: []engine.Type{engine.TMap, engine.TMap}, Handler: listAPIOptsHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TMap}, Handler: listAPIHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TList, engine.TMap}, Handler: listFilterHandler},
	...
	// ---- create ----
	{
		...
		ForwardPrecedence: true,
		Signatures: []engine.NativeSig{
			{Args: []engine.Type{engine.TResourceEntity, engine.TMap}, Handler: createEntityOptsHandler},
			{Args: []engine.Type{engine.TResourceEntity}, Handler: createEntityHandler},
			{Args: []engine.Type{engine.TMap, engine.TMap}, Handler: createAPIOptsHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TMap}, Handler: createAPIHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TList, engine.TMap}, Handler: createHandler},
	...
	// ---- load ----
	{
		...
		ForwardPrecedence: true,
		Signatures: []engine.NativeSig{
			{Args: []engine.Type{engine.TResourceEntity, engine.TMap}, Handler: loadEntityOptsHandler},
			{Args: []engine.Type{engine.TResourceEntity}, Handler: loadEntityHandler},
			{Args: []engine.Type{engine.TMap, engine.TMap}, Handler: loadAPIOptsHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TMap}, Handler: loadAPIHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TList, engine.TMap}, Handler: loadHandler},
	...
	// ---- update ----
	{
		...
		ForwardPrecedence: true,
		Signatures: []engine.NativeSig{
			{Args: []engine.Type{engine.TResourceEntity, engine.TMap}, Handler: updateEntityOptsHandler},
			{Args: []engine.Type{engine.TResourceEntity}, Handler: updateEntityHandler},
			{Args: []engine.Type{engine.TMap, engine.TMap}, Handler: updateAPIOptsHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TMap}, Handler: updateAPIHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TList, engine.TMap}, Handler: updateHandler},
	...
	// ---- remove ----
	{
		...
		ForwardPrecedence: true,
		Signatures: []engine.NativeSig{
			{Args: []engine.Type{engine.TResourceEntity, engine.TMap}, Handler: removeEntityOptsHandler},
			{Args: []engine.Type{engine.TResourceEntity}, Handler: removeEntityHandler},
			{Args: []engine.Type{engine.TMap, engine.TMap}, Handler: removeAPIOptsHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TMap}, Handler: removeAPIHandler, Patterns: map[int]engine.Value{0: apiPatternValue()}},
			{Args: []engine.Type{engine.TList, engine.TMap}, Handler: removeHandler},
