...
implementing a new native module, `boru:debug`, end to end: a design note
...
written in the spirit of the prior `BORU-DX-REPORT.5.md` (the `boru:decision`
report) — honest friction, not a scorecard.

Verified against `cmd/go/bin/boru` on branch `claude/boru-debug-module-mk72i9`.
