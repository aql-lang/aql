...
Benchmark-goroutine path = `AQL.Run` 3.60s of 4.65s samples.
Within it:

| where | cum | share of AQL.Run |
|---|---:|---:|
...
`aql-bytecode-plan.0.md`. The dispatch machinery's share on
