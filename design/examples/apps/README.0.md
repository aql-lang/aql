# Networking verification apps (working examples)

Working AQL programs that verify the networking stack end to end —
the acceptance apps of `design/NETWORK-IMPLEMENTATION-PLAN.0.md` §1.5.
...
`lang/go/test/apps_test.go` (plus `aql:repl`, the fourth app, which
