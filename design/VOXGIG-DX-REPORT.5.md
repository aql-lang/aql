...
| B5 | 🟢 | ❌ open → ADR-005 / `design/CLASS-OBJECT.0.md` | `make Object {}` rejected: "expected a constructed object type, got Object". Resolution changed 2026-06-09: under the accepted container-symmetry decision, `make Object {}` will become *valid* (an empty mutable Object, Phase 2 of the class/object split) — resolved by design, superseding the hint proposal that briefly lived in `design/ERRORS.0.md` §4. |
