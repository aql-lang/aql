...
func TestCallDynamicTrailingNonCallable(t *testing.T) {
	...
	prog := &Program{
		Consts: []Value{NewInteger(99), NewInteger(5)},
		Code: []Instr{
			{Op: OpPushConst, Arg: 0},           // value 99 (a plain Integer — NOT callable) at the base
			{Op: OpPushConst, Arg: 1},           // its arg, 5, above
			{Op: OpCallDynamicTrailing, Arg: 1}, // apply value to 1 arg below — but it is not callable
		},
		Debug: []SrcPos{{}, {}, {}},
	}
