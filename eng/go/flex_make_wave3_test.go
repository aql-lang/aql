...
// Coverage for the flex-container conversion primitives (core_flex.go:
// AdoptIntoFlex / AdoptIntoNode / MakeNodeHandler) and the remaining
// make-dispatch handlers (core_make.go: MakeWithOpts, MakeScalarHandler,
// MakeObjHandler, MakeScalarOptsHandler, parseMakeOptions,
// builtinBaseOf, CheckMakeConstruction, ResolveFieldType).
